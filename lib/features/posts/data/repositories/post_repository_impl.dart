...
// import 'package:clean_architecture_starter/features/posts/data/datasource's/post_local_data_source.dart';
...
import 'package:clean_architecture_starter/core/network/network_info.dart';
import 'package:dartz/dartz.dart';
...
class PostsRepositoryImpl implements PostsRepository {
  ...
  Future<Either<Failure, Unit>> addPost(Post post) async {
    final PostModel postModel = PostModel(title: post.title, body: post.body, id: post.id);
